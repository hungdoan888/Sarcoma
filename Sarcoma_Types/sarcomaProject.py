...
if __name__ == "__main__":
    ...
    for i in range(len(myFiles)):
        ...
        if myFile.endswith("_clinical_data.csv") or myFile.endswith("_clinical_data.tsv"):
            ...
            if (nameOfSarcoma == "AllSarc" or 
                nameOfSarcoma == "BnSarc" or 
                nameOfSarcoma == "STS" or
                nameOfSarcoma == "BCORSTS" or
                nameOfSarcoma == "BCORBone" or
                nameOfSarcoma == "CICBone" or
                nameOfSarcoma == "CICSTS" or
                nameOfSarcoma == "YWHAEEndomet" or
                nameOfSarcoma == "InflammatoryMyofibroblastic" or
                nameOfSarcoma == "NTRKRRSTS" or
                nameOfSarcoma == "RoundCell" or
                nameOfSarcoma == "RCCEWSR1nonETS"):
